...
func (t ForcedDarkTheme) Color(name fyne.ThemeColorName, variant fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNameMenuBackground: // Фон выпадающих меню (строки меню, контекстные меню)
		return color.NRGBA{R: 60, G: 63, B: 60, A: 240}
	...
	case ColorCRTScreenFill:
		return color.NRGBA{R: 192, G: 255, B: 26, A: 15}
	case ColorCRTScreenStroke:
		return color.NRGBA{R: 192, G: 255, B: 26, A: 111}
	...
	case ColorTopPanelBg:
		return color.NRGBA{R: 22, G: 22, B: 22, A: 255}
	case ColorTipBg:
